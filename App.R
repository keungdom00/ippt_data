...
Measurements <- read.csv(file = "https://raw.githubusercontent.com/keungdom00/ippt_data/refs/heads/main/TUGbalanceData.csv", header = TRUE, sep = ",")
